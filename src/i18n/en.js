const ja = {
  ...
  "Top.SurveyMes":
    "To make BPIManager more useful, please cooperate with a survey.",
  "Index.heroText":
    "Easily manage your beatmania IIDX scores and visualize them as BPI, in Web.",
  ...
  "Index.notes1":
    "beatmania is the trademark registered by Konami Degital Entertainment Co., Ltd.",
  "Index.notes2":
    "BPIManager was created by the one who has no relationship with that corporation.",
  "Index.notes3":
    "This tool was affected by both of BPI which was invented by norimiso and BPICL which was released by ZUBU.",
  ...
  "Settings.dpDescription":
    "When turning on this function you can register double play scores.",
  "Settings.noteLang":
    "Select the language you want to use. Please contribute to improve the quality of translation.(contact @BPIManager)",
  "Settings.noteMes1":
    "Registering scores for older IIDX versions makes you able to compare them across versions.",
  "Settings.inaccurateMes":
    "Please note that since BPIs in older IIDX versions will also be calculated with the latest WR and average scores so they would be rather inaccurate than them at the time.",
  ...
  "Settings.resetWarning":
    "Delete all data stored in the selected database. WARNING: BE AWARE THAT THIS ACTION CANNOT BE UNDONE.",
  "Settings.DeleteExec": "Execute",
  "Settings.DeleteDialogBody":
    "You are about to delete all scores stored in the selected database.",
  "Settings.DeleteDialogBody2":
    "This action cannot be undone. Really do you want to continue to delete this data :",
  "Settings.MyGoalBPI": "Target BPI",
  "Settings.MyGoalPercentage": "Target Percentage",
  "Settings.MyGoalDescription":
    "Setting values above makes it possible to compare with EX score corresponding to them in Compare screen. ",
  ...
  "Settings.syncDescription":
    "Save your scores on the Internet and synchronize them on multiple devices!(You need to sign in with Twitter)",
  "Sync.Control.message1":
    "You can upload scores by every IIDX versions and playstyles(single or double play)",
  "Sync.Control.message2":
    "You cannot upload/download scores if already reached to the daily limitation of database.",
  ...
  "Sync.Login.description":
    "User authentication data will be only used for identifying users and will not be used for creating new posts or changing a personal data without any permissions.",
  "Sync.Login.note1":
    "*Since we're using Free trial version of Firebase, there is a limitation of reading/writing database shared by all users.(daily 50,000 reads and 20,000 writes)",
  "Sync.Login.note2":
    "You could be banned for a while to use this function if you are using in abusive way which will cause trouble for other users.",
  "Sync.Public0":
    "You can share your score data with others by submitting a name in the form.",
  "Sync.Public2":
    "Click here to learn more about the rival feature(Japanese only).",
  "Settings.defFileURLButton":
    "Change the url for the definition file(for advanced users)",
  "Settings.ChangeDefinitionURL":
    "You can change the url for the definition file. Please read ",
  "Settings.ChangeDefinitionURL2": "this page",
  "Settings.ChangeDefinitionURL3":
    " to learn about the format for definition files and precautions.",
  "Settings.ChangeDefinitionURL4":
    "Leave form blank and save to apply the default url.",
  ...
  "Settings.Themes":
    "Please choose app appearance from 3 themes: Light / Dark / Deep Sea",
  "Settings.AutoSync1":
    "When turning on this config, automatically upload the latest score data to the server.",
  "Settings.AutoSync2":
    "Since a sequence of processes is asynchronous, it does not affect the import time.",
  "Settings.AutoSync3":
    "When you have not been logged into BPIManager, this configure will be ignored.",
  "Settings.AreaTitle": "Region",
  "Settings.Area":
    "By selecting the area you belong to, you can open the TOP RANKER page for the  corresponding area and song from the detail-screen.",
  "Settings.View": "Sub display",
  "Settings.View1":
    "Check out all components you want to display on the list of songs.",
  "Settings.View2":
    '"Updated diffs from the previous score" may delay the rendering of the page depending on the machine spec and the number of items displayed.',
  "Settings.View.TB": "Tweet button (on detail screen)",
  "Settings.View.TBCaption":
    "Show a button on the Graph tab in detail-screen that allows you to tweet BPI growth, EX score, etc.",
  "Settings.UseTraditional": "Use the legacy calculation formula",
  "Settings.UseTraditional1":
    "計算式上における係数を1.5に固定してBPIを計算します。",
  "Settings.UseTraditional2":
    "全数値を再計算するため、変更の適用には時間がかかります。",
  "Common.Apply": "Apply",
  "Settings.Export": "エクスポート",
  "Common.CurrentVer": "現在のバージョン",
  "Settings.ExportCaption":
    "登録されたスコアデータおよびメタデータをCSVで書き出します。",
  ...
  "Data.CopyAfter":
    " and copy the text displayed on IIDX Official site to the clipboard.",
  "Data.Import": "Import",
  "Data.ImportText": 'Click "Import" button to execute importation.',
  "Data.ImportFails":
    "If the import process fails, please paste the text in the box below and execute again.",
  "Data.Result": "Result",
  "Data.ResultText":
    "The Consequence of the importation this time is shown below.",
  ...
  "Signin.list3":
    "Find rivals with similar abilities based on BPI and arena rank",
  "Signin.list4": "Interact with other users through Notes and ArenaMatch",
  "Signin.warn1":
    "Available OAuth login via Twitter or Google. The account you linked is used only for user identification, and we have no authority to create posts or edit profiles of your account.",
  "Signin.warn2":
    "When creating an account, we assume you have agreed to the term of use and privacy policy.",
