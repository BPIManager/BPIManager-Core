      ...
      return (
        <Container fixed className="commonLayout">
          ...
          >
            ...
            <Typography variant="h4">ライバルを追加</Typography>
          </div>
          <Divider style={{ margin: "10px 0" }} />
          <p>
            このページでは、各楽曲ごとにライバルとの勝敗比較を行うことができます。
            <br />
            まずは実力の近いユーザーを探して、ライバルとして追加しましょう！
            <br />
          </p>
          <List>
            {[
              {
                name: "おすすめユーザー",
                func: () => this.props.history.push("/rivals?tab=1"),
                desc: "総合BPIが近いユーザーを表示します",
                icon: <ThumbUpIcon />,
              },
              {
                name: "探す",
                func: () => this.props.history.push("/rivals?tab=3"),
                desc: "様々な条件からユーザーを検索します",
                icon: <SearchIcon />,
              },
            ].map((item, i) => {
              return (
