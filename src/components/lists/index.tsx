...
export const listNobi11 = {
  description: "単曲BPIが総合BPIよりもだいぶ低い楽曲(☆11)",
  icon: "https://files.poyashi.me/bpim/grow11.jpg",
  length: -1,
  num: -11,
  title: "伸びるかも(☆11)",
  updatedAt: "-1",
};
export const listNobi12 = {
  description: "単曲BPIが総合BPIよりもだいぶ低い楽曲(☆12)",
  icon: "https://files.poyashi.me/bpim/grow.jpg",
  length: -1,
  num: -12,
  title: "伸びるかも(☆12)",
  updatedAt: "-1",
...
export const getListsForNobi = async (targetLevel = 12) => {
  ...
  return songs.filter(
    (item: scoreData) =>
      ...
      item.currentBPI < Math.pow(totalBPI, 0.9)
  );
};
