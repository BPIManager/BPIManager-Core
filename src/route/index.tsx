...
import SyncDelete from "../view/components/sync/delete";
...
import SongsIndex from "@/view/pages/songs/index";
...
export const Router: React.FC<{ global: UnstatedContainer<any> }> = (props) => {
  ...
  return (
    <IntlProvider locale={global.state.lang} messages={global.state.lang === "ja" ? ja : en}>
      <BrowserRouter>
        <AppBar global={global}>
          <Switch>
            ...
            <Route path="/sync/delete" exact component={SyncDelete} />
