  ...
  render() {
    ...
    return (
      <div style={{ display: "flex", justifyContent: "center", flexDirection: "column", position: "relative", height: "85vh" }}>
        <Webcam audio={false} ref={this.camRef} style={{ maxHeight: "80vh" }} height={100 + "%"} width={100 + "%"} screenshotFormat="image/jpeg" forceScreenshotSourceSize videoConstraints={options} />
        ...
        <IconButton onClick={this.props.toggleSettings} style={{ position: "absolute", bottom: "5%", right: "5%", margin: "15px 0" }} size="large">
          <SettingsIcon />
        </IconButton>
      </div>
    );
