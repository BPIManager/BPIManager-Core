...
const background = () => {
  ...
  if (themeColor === "dark")
    return "linear-gradient(0, rgba(10,10,10,0) 0%, rgba(37,37,37,1) 100%)";
  return "linear-gradient(0, rgba(255,255,255,1) 0%, #D8CCBE 100%)";
};
      ...
      >
        <Grid container alignItems="center">
          ...
          <SubHeader
            title="総合BPI"
            body={String(
              Number.isNaN(meta.totalBPI) ? "-" : meta.totalBPI.toFixed(2)
            )}
          />
        </Grid>
        <Typography
