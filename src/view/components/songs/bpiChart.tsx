...
const BPIChart: React.FC<P> = ({ song, score, chartData, graphLastUpdated, newScore }) => {
        ...
        <div className="noBPIAlert">
          ...
          <div>
            <p style={{ textAlign: "center", fontSize: 8 }}>
              ...
              <Link href="https://gist.github.com/potakusan/b5768f3ec6c50556beec50dd14ebaf23" target="_blank" color="secondary">
                詳細はこちら
              </Link>
              &nbsp;|&nbsp;
