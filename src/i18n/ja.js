const ja = {
  ...
  "Help.Disclaimer":"免責事項・利用制限",
  "Help.G":"本ツールにより提供される機能やソフトウェアの不具合によって生じたいかなる損害に対しても、製作者(@notAesthet1c)は一切責任を負いかねますのであらかじめご了承ください。",
  "Help.G.2":"本ツールに搭載されたライバル機能のご利用につき、下記行為を行わないでください。各項につき悪質な違反があった場合、ユーザーIDの一定期間凍結やその他必要と判断する措置を講ずることがありますので、予めご了承ください。",
