    ...
    return (
      <React.Fragment>
        ...
        <Snackbar
          ...
          message="定期的なアリーナランク情報の収集にご協力ください。"
          action={action}
        />
        <Snackbar
          open={completed}
    ...
    return (
      ...
      >
        ...
        <DialogContent dividers>
          {!loading && (
            <React.Fragment>
              <Typography variant="body1">アリーナランク別平均を算出するため、定期的に最新のアリーナランクを集計しています。<br />現在のアリーナランクを選択の上「Ok」ボタンから送信してください。</Typography>
              <RadioGroup
                name="arenaRank"
                value={selected}
        ...
        <DialogActions>
          ...
          <Button disabled={loading} onClick={this.update}>Ok</Button>
        </DialogActions>
      </Dialog>
    );
  }
