const ja = {
  ...
  "Help.G.3":"・Write untrue or incorrect information.",
  "Help.G.4":"・Any acts that slanders, intimidates or compels others.",
  "Help.G.5":"・Any acts that violate or may threaten the property, honor, privacy, or portrait rights of others.",
  "Help.G.6":"・Provide for-profit information, sales activities, or missionary activities.",
  "Help.G.7":"・Use the service by impersonating others.",
  "Help.G.8":"・Any acts similar to contributing to anti-social activities.",
  "Help.G.9":"・Any acts that intentionally places an excessive load on this tool or the server that provides functions of this tool.",
  "Help.G.10":"・Any acts similar to damaging the credibility of this tool.",
  "Help.G.11":"・Any acts that violate laws or public order and morals.",
  "Help.G.12":"・Other acts that the administrator has determined to be inappropriate.",
  "Help.G.13":"3. Users' score data accumulated through this tool may be used after anonymization processing to improve the function of this tool.",
  "Help.G.14":"4. The administrator reserves the right to change these terms and conditions at any time without prior notice.",
  ...
  "Data.CopyAfter":" and copy text on IIDX Official site to the clipboard.",
  "Data.Import":"Import",
  "Data.ImportText":"Click \"Import\" button to excute importation.",
  "Data.ImportFails":"If import processes fail, please paste the text in the box below and execute again.",
  "Data.Result":"Result",
  "Data.ResultText":"Consequences of the importation will be show below.",
