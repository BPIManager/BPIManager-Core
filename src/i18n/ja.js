const ja = {
  ...
  "Help.H.1":"BPIManagerを「かゆいところまで手が届く、スコアのみならずモチベーションをも向上させるツール」とすべく、インフラを維持し、より優れた機能を提供するために、少なくない金銭的・時間的コストが掛かっています。",
  "Help.H.2":"もし本ツールの開発理念に共感して頂ける場合は、Amazonギフト券を「msqkn310@gmail.com」までご送信いただけたら無上の喜びです。",
  "Help.H.3":"送金は15円から可能です。よろしくお願いいたします。",
